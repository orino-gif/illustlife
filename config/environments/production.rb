Rails.application.configure do
  ...
  # config.action_controller.asset_host = 'https://defomate.com/'
  ...
  # config.active_job.queue_name_prefix = "illustlife_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = {  :host => 'defomate.com', :protocol => 'https' }
